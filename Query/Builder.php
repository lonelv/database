...
use Itxiao6\Database\ConnectionInterface;
...
class Builder
{
     ...
     *
     * @param  \Itxiao6\Database\ConnectionInterface  $connection
     ...
     * @return \Itxiao6\Database\Query\Builder|static
     */
     ...
     *
     * @param  string   $column
     * @param  \Itxiao6\Database\Query\Builder|static  $query
     * @param  string   $boolean
     * @param  bool     $not
     * @return $this
     */
     ...
     *
     * @param  \Itxiao6\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return \Itxiao6\Database\Query\Builder|static
     */
...
//        ]);
     ...
     *
     * @return \Itxiao6\Database\ConnectionInterface
     */
