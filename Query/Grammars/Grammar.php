...
namespace Itxiao6\Database\Query\Grammars;

use Illuminate\Support\Arr;
use Itxiao6\Database\Query\Builder;
use Itxiao6\Database\Query\JoinClause;
use Itxiao6\Database\Grammar as BaseGrammar;
...
class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \Itxiao6\Database\Query\Builder
     * @param  array  $orders
     * @return array
     */
