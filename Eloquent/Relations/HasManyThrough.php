...
use Itxiao6\Database\Eloquent\Builder;
use Itxiao6\Database\Eloquent\Collection;
use Itxiao6\Database\Eloquent\SoftDeletes;
use Itxiao6\Database\Eloquent\ModelNotFoundException;
...
class HasManyThrough extends Relation
{
     ...
     *
     * @var \Itxiao6\Database\Eloquent\Model
     */
     ...
     * @param  \Itxiao6\Database\Eloquent\Model  $farParent
     * @param  \Itxiao6\Database\Eloquent\Model  $throughParent
     ...
     *
     * @param  \Itxiao6\Database\Eloquent\Builder|null  $query
     * @return void
     */
     ...
     *
     * @param  array  $columns
     * @return \Itxiao6\Database\Eloquent\Model|static
     *
     * @throws \Itxiao6\Database\Eloquent\ModelNotFoundException
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Itxiao6\Database\Eloquent\Model|\Itxiao6\Database\Eloquent\Collection|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Itxiao6\Database\Eloquent\Model|\Itxiao6\Database\Eloquent\Collection
     *
     * @throws \Itxiao6\Database\Eloquent\ModelNotFoundException
     */
     ...
     *
     * @param  \Itxiao6\Database\Eloquent\Builder  $query
     * @param  \Itxiao6\Database\Eloquent\Builder  $parentQuery
