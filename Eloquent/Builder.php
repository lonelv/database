...
/**
 * @mixin \Itxiao6\Database\Query\Builder
 */
class Builder
{
     ...
     *
     * @var \Itxiao6\Database\Query\Builder
     */
    protected $query;
     ...
     * @param  \Itxiao6\Database\Eloquent\Scope|\Closure  $scope
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Itxiao6\Database\Eloquent\Model|\Itxiao6\Database\Eloquent\Collection|static[]|static|null
     */
     ...
     * @return \Itxiao6\Database\Eloquent\Model|static|mixed
     */
     ...
     *
     * @param  string  $name
     * @return \Itxiao6\Database\Eloquent\Relations\Relation
     */
