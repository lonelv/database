...
trait QueriesRelationships
{
     ...
     *
     * @param  \Itxiao6\Database\Eloquent\Builder  $hasQuery
     * @param  \Itxiao6\Database\Eloquent\Relations\Relation  $relation
     * @param  string  $operator
     * @param  int  $count
     * @param  string  $boolean
     * @return \Itxiao6\Database\Eloquent\Builder|static
     ...
     *
     * @param  \Itxiao6\Database\Eloquent\Builder  $from
     * @return \Itxiao6\Database\Eloquent\Builder|static
     */
